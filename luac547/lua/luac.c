...
#define OUTPUT		"out.luac"	/* default output file */
...
{
	char str[256];
	sprintf(str, "%s: incorrect usage for %s: %s\n", progname, output, reason);
	ErrorMessage(str);
}
...
static int pcompile(lua_State* L)
{
